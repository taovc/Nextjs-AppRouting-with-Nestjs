    ...
    <form onSubmit={onSubmit} className={cn("w-full", className)}>
      ...
      >
        ...
        <input
          ...
          autoComplete="off"
          className={cn(
            "search px-12 item-center flex h-full w-full appearance-none overflow-hidden truncate rounded-lg text-sm text-heading placeholder-gray-500 transition duration-300 ease-in-out focus:outline-none focus:ring-0",
            {
        ...
        {value && (
          <button
            ...
            className={cn(
              "absolute right-0 flex h-full w-10 cursor-pointer items-center justify-center text-body transition-colors duration-200 hover:text-accent-hover focus:text-accent-hover focus:outline-none md:w-14",
              {
